...
namespace UI.Web
{
    public partial class Materias : ApplicationForm
    {
        ...
        private void LoadGrid()
        {
            try
            {
                this.gridView.DataSource = new MateriaLogic().GetAll();
        ...
        protected void NuevaMateria_Click(object sender, EventArgs e)
        {
        ...
        private void RedirectToCursoManagement(FormModes formMode)
        {
            ...
            Response.Redirect($"MateriaManagment.aspx?FormMode={this.FormMode}&e={encodedEncryptedQueryString}");
        }

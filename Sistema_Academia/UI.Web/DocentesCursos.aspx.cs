...
namespace UI.Web
{
    public partial class DocentesCursos : ApplicationForm
    {
        ...
        private void LoadGrid()
        {
            try
            {
                this.gridView.DataSource = new DocenteCursoLogic().GetAll();
        ...
        protected void NuevoDocenteCurso_Click(object sender, EventArgs e)
        {
        ...
        private void RedirectToCursoManagement(FormModes formMode)
        {
            ...
            Response.Redirect($"DocenteCursoManagment.aspx?FormMode={this.FormMode}&e={encodedEncryptedQueryString}");
        }
    }
}
...
namespace UI.Web
{
    public partial class Especialidades : ApplicationForm
    {
        ...
        private void LoadGrid()
        {
            try
            {
                this.gridView.DataSource = new EspecialidadLogic().GetAll();
        ...
        protected void NuevaEspecialidad_Click(object sender, EventArgs e)
        {
        ...
        private void RedirectToCursoManagement(FormModes formMode)
        {
            ...
            Response.Redirect($"EspecialidadManagment.aspx?FormMode={this.FormMode}&e={encodedEncryptedQueryString}");
        }
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanManagment.aspx.cs" Inherits="UI.Web.PlanManagment" %>
...
<body>
    <form id="formularioPlanes" runat="server">
        <div class="container">
            ...
            <asp:LinkButton runat="server" PostBackUrl="~/Planes.aspx" CssClass="btn  btn-primary mt-4">Volver</asp:LinkButton>
            <br />
...
<%--AutoPostBack="True" OnSelectedIndexChanged="ddlLegajos_SelectedIndexChanged"--%>

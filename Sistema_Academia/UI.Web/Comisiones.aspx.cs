...
namespace UI.Web
{
    ...
    { 
        ...
        private void LoadGrid()
        {
            try
            {
                this.gridView.DataSource = new ComisionLogic().GetAll();
        ...
        protected void NuevaComision_Click(object sender, EventArgs e)
        {
        ...
        private void RedirectToCursoManagement(FormModes formMode)
        {
            ...
            Response.Redirect($"ComisionManagment.aspx?FormMode={this.FormMode}&e={encodedEncryptedQueryString}");
        }
    }
}
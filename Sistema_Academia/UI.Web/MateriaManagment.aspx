<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MateriaManagment.aspx.cs" Inherits="UI.Web.MateriaManagment" %>
    ...
    <form id="formularioMaterias" runat="server">
        <div class="container">
            ...
            <div class="mb-1">
                ...
                <asp:TextBox ID="txtHorasSemanales" runat="server" CssClass="form-control"></asp:TextBox>
            </div>

            <div class="mb-1">
                <label class="col-form-label">Horas Totales</label>
                <asp:TextBox ID="txtHorasTotales" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <asp:LinkButton runat="server" PostBackUrl="~/Materias.aspx" CssClass="btn  btn-primary mt-4">Volver</asp:LinkButton>
            <br />

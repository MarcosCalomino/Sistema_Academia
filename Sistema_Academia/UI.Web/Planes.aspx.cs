...
namespace UI.Web
{
    public partial class Planes : ApplicationForm
    {
        ...
        private void LoadGrid()
        {
            try
            {
                this.gridView.DataSource = new PlanLogic().GetAll();
        ...
        protected void NuevoPlan_Click(object sender, EventArgs e)
        {
        ...
        private void RedirectToCursoManagement(FormModes formMode)
        {
            ...
            Response.Redirect($"PlanManagment.aspx?FormMode={this.FormMode}&e={encodedEncryptedQueryString}");
        }
    }
}